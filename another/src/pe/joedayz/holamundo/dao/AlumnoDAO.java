...
public class AlumnoDAO extends SQLiteOpenHelper{
	...
	public List<Alumno> getLista() {
		String[] columnas = {"id", "nombre", "site",
				"telefono", "direccion", "foto", "nota"};
		Cursor cursor = getWritableDatabase().query("Alumno",
	...
	public void modificar(Alumno alumno) {
		...
		String[] args={alumno.getId().toString()};
		getWritableDatabase().update("Alumno", values, "id=?", args);
	}
